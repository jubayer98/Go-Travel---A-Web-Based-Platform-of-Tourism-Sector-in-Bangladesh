      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <hr>
            <form name="Traveler Information" class="form-horizontal" method="post" action="<?php echo base_url();?>Traveler/travelerRegistrationInformation">
  <div class="form-group">
    <label for="inputTravelerFullName" class="col-sm-2 control-label">Full Name</label>
    <div class="col-sm-10">
      <input type="name" class="form-control" name="inputTravelerFullName" placeholder="Full Name" required="">
    </div>
  </div>
  <div class="form-group">
    <label for="inputTravelerEmail" class="col-sm-2 control-label">Email</label>
    <div class="col-sm-10">
      <input type="Email" class="form-control" name="inputTravelerEmail" placeholder="Email" required="">
    </div>
  </div>
  <div class="form-group">
    <label for="inputTravelerPassword" class="col-sm-2 control-label">Password</label>
    <div class="col-sm-10">
      <input type="Password" class="form-control" name="inputTravelerPassword" placeholder="Password" required="">
    </div>
  </div>
  <div class="form-group">
