...
<main role="main">
	...
	<br><br><br>
	<div class="container">
		<p class="alert alert-success">Hey! <span style="color: #bb8844"><?php echo $this->session->userdata('inputTravelerFullName'); ?></span>, from here you can update your <strong>Traveling Experience</strong> information.</p>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<form method="post" action="<?php echo base_url();?>TravelerAdminC/updatedTravelerExperienceInformation.html" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="travelerExperienceTitle" class="col-sm-2 col-form-label">Experience Title</label>
						<div class="col-sm-10">
							<input type="hidden" class="form-control" name="experience_id" value="<?php echo $updateTravelerExperienceInformation->experience_id?>">
							<input type="name" class="form-control" name="inputExperienceTitle" value="<?php echo $updateTravelerExperienceInformation->inputExperienceTitle?>" placeholder="Enter Experience Title" required="">
						</div>
					</div>
					<div class="form-group row">
						<label for="travelerExperienceDetails" class="col-sm-2 col-form-label">Experience Details</label>
						<div class="col-sm-10">
							<textarea type="text" class="form-control" name="inputExperienceDetails" placeholder="Enter Experience Details" required=""><?php echo $updateTravelerExperienceInformation->inputExperienceDetails?></textarea>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<select name="inputTravelingDivision" class="form-control" required="">
								<?php echo $updateTravelerExperienceInformation->inputTravelingDivision?>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea type="text" class="form-control" name="inputTravelingThingsToRemember" placeholder="Enter What Should Be Remembered" required=""><?php echo $updateTravelerExperienceInformation->inputTravelingThingsToRemember?></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label for="travelerExperienceExpense" class="col-sm-2 col-form-label">Possible Expense (PP)</label>
						<div class="col-sm-10">
							<input type="name" class="form-control" name="inputTravelingPossibleExpense" value="<?php echo $updateTravelerExperienceInformation->inputTravelingPossibleExpense?>" placeholder="Enter Possible Expense for Per Person" required="">
						</div>
					</div>
					<div class="form-group row">
						<label for="addTravelPlacePicturesFile" class="col-sm-2 col-form-label">Moment of Your Experience</label>
						<div class="col-sm-10">
							<input type="file" class="form-control-file" name="inputTravelMomentExperiencePicture" value="<?php echo $updateTravelerExperienceInformation->inputTravelMomentExperiencePicture?>" required="">
						</div>
					</div>
					<div class="row">
						<div class="col-12">
