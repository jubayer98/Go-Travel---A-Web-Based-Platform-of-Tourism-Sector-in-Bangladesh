...
<main role="main">
	...
	<br><br><br>
		<div class="container">
			<h3 class="alert alert-success">Welcome, <span style="color: #bb8844"><?php echo $this->session->userdata('inputAgencyName'); ?></span></h3>
		</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<form method="post" action="<?php echo base_url();?>AgencyAdminC/saveTourPackageInformation.html" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="tourPackageTitle" class="col-sm-2 col-form-label">Package Title</label>
						<div class="col-sm-10">
							<input type="name" class="form-control" name="inputPackageTitle" placeholder="Enter Package Title" required="">
						</div>
					</div>
					<div class="form-group row">
						<label for="tourPackageDetails" class="col-sm-2 col-form-label">Package Details</label>
						<div class="col-sm-10">
							<textarea type="text" class="form-control" name="inputPackageDetails" placeholder="Enter Package Details" required=""></textarea>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="inputPackagePrice" placeholder="Enter Package Price" required="">
						</div>
					</div>
					<div class="form-group row">
						<label for="tourPackageContactNumber" class="col-sm-2 col-form-label">Contact No</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="inputPackageContactNo" placeholder="Enter Contact No" required="">
						</div>
					</div>
					<div class="form-group row">
						<label for="addPackageBannerFile" class="col-sm-2 col-form-label">Add Banner File</label>
						<div class="col-sm-10">
							<input type="file" class="form-control-file" name="inputPackageBannerFile" required="">
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<button type="submit" class="btn btn-warning" style="float: right">Create Tour Package</button>
						</div>
					</div>
				</form>
			</div>
