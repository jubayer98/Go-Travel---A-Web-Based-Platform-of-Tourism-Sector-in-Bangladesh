...
<main role="main">
	...
	<br><br><br>
	<div class="container">
		<h3 class="alert alert-success">Welcome, <span style="color: #bb8844"><?php echo $this->session->userdata('inputContributerFullName'); ?></span></h3>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<form method="post" action="<?php echo base_url();?>ContributerAdminC/saveContributionThingInformation.html" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="contributionThingTitle" class="col-sm-2 col-form-label">Tourist Place Name</label>
						<div class="col-sm-10">
							<input type="name" class="form-control" name="inputTouristPlaceName" placeholder="Enter Tourist Place Name" required="">
						</div>
					</div>
					<div class="form-group row">
						<label for="contributionThingDetails" class="col-sm-2 col-form-label">Place Details</label>
						<div class="col-sm-10">
							<textarea type="text" class="form-control" name="inputPlaceDetails" placeholder="Enter Place Details" required=""></textarea>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea type="text" class="form-control" name="inputCommunicationDetails" placeholder="Enter Communication Details" required=""></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label for="addTouristPlacePicturesFile" class="col-sm-2 col-form-label">Add Tourist Place Picture</label>
						<div class="col-sm-10">
							<input type="file" class="form-control-file" name="inputTouristPlacePicture" required="">
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							<button type="submit" class="btn btn-warning" style="float: right">Make Your Contribution</button>
						</div>
					</div>
				</form>
			</div>
