      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <hr>
            <form name="Contributer Login" class="form-horizontal" method="post" action="<?php echo base_url();?>ContributerLC/checkContributerLogin.html">
